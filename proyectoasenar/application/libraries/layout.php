...
/**
	 ...
	 */	
	public $title       = '..:: ASENAR ::..';	
    public $name       = 'sistema de genstion de pedidos';	
	public $keywords    = 'pedidos,comida,cena,restaurante';	
	public $descripcion = 'sistema para gestionar perdidos a la cafeteria';
