		...
		<body>
			<div class="wrapper">
			    <div class="sidebar" data-color="orange" data-image="<?php echo base_url();?>public/img/sidebar-1.jpg">
					...
					<div class="logo" style="background: #f4551e"; >
						<a href="#!" class="simple-text">
							<h4 style="color: #fff">ASENAR</h4>
						</a>
						
					
					</div>
			    	<div class="sidebar-wrapper" style="background: #ff6e40;">
			            <ul class="nav">
			                <li>
			                    <a href="#">
	    ...
	    <div class="main-panel">
			<nav class="navbar navbar-absolute" style="background: 	 rgba(244, 85, 30, 0.47);">
